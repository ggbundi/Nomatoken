...
import { Settings, Eye, EyeOff, Smartphone, Monitor } from 'lucide-react';
...
export const SimpleAnimationControls: React.FC<SimpleAnimationControlsProps> = ({
  className,
  compact = false
}) => {
    ...
    <>
      ...
      {prefersReducedMotion && (
        <div className="p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
          ...
          <div className="text-xs text-blue-700 dark:text-blue-300 mt-1">
            ...
            You can override this below if desired.
          </div>
        </div>
      )}
      ...
      {deviceType === 'mobile' && (
        <div className="text-xs text-muted-foreground p-2 bg-muted/50 rounded">
          <strong>Mobile Optimized:</strong> Background animations are disabled 
          and intensity is automatically reduced to preserve battery life.
        </div>
      )}
    </>
  );
